                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Professors" href="<?php echo base_url("dosen/index"); ?>"><span class="mini-sub-pro">List Dosen</span></a></li>
                                <li><a title="Add Professor" href="<?php echo base_url("dosen/tambah"); ?>"><span class="mini-sub-pro">Tambah Dosen</span></a></li>
                                <li><a title="Edit Professor" href="<?php echo base_url("dosen/dosen_ubah"); ?>"><span class="mini-sub-pro">Edit Dosen</span></a></li>
