...
<body>
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Professors" href="all-professors.html"><span class="mini-sub-pro">List Dosen</span></a></li>
                                <li><a title="Add Professor" href="add-professor.html"><span class="mini-sub-pro">Tambah Dosen</span></a></li>
                                <li><a title="Edit Professor" href="edit-professor.html"><span class="mini-sub-pro">Edit Dosen</span></a></li>
                                <li><a title="Professor Profile" href="professor-profile.html"><span class="mini-sub-pro">Profil Dosen</span></a></li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <li>
                            <a class="has-arrow" href="all-courses.html" aria-expanded="false"><span class="educate-icon educate-department icon-wrap"></span> <span class="mini-click-non">Program Studi</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Departments List" href="departments.html"><span class="mini-sub-pro">List Program Studi</span></a></li>
                                <li><a title="Add Departments" href="add-department.html"><span class="mini-sub-pro">Tambah Program Studi</span></a></li>
                                <li><a title="Edit Departments" href="edit-department.html"><span class="mini-sub-pro">Edit Program Studi</span></a></li>
                            </ul>
                        </li>
    ...
    <div class="all-content-wrapper">
        ...
        <div class="header-advance-area">
            ...
            <a href='<?php echo base_url("dosen/tambah"); ?>'>Tambah Data</a><br><br>
            ...
            <table id="tablenya" border="1" cellpadding="7">
                ...
                if( ! empty($dosen)){
                    foreach($dosen as $datadosen){
                        ...
                        <td><a href='".base_url("dosen/ubah/".$datadosen->nip)."'>Ubah</a></td>
                        <td><a href='".base_url("dosen/hapus/".$datadosen->nip)."'>Hapus</a></td>
                        </tr>";
                    }
                }else{ 
